...
import { IRCalculationResult, IExtendedRCalculationResult, QuestionIrtParamInfo } from "../../src/ApplicationImplementation/Edgar/Statistics/IRCalculationResult.js";
import { IIRTParameterCalculator, QuestionCalcultionInfo } from "../../src/ApplicationImplementation/Models/IRT/IIRTParameterCalculator.js";
import { AbstractGenericJobStep } from "../../src/ApplicationModel/Jobs/AbstractGenericJobStep.js";
import { JobStepDescriptor, IJobConfiguration } from "../../src/ApplicationModel/Jobs/IJobConfiguration.js";
...
const impl: IRegistryPlugin = {
    ...
    registry: "JobStep",
    creationFunction(stepDescriptor: JobStepDescriptor, jobConfig: IJobConfiguration, ...args: any[]): object {

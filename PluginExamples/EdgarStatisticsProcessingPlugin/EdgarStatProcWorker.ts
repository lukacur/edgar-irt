...
import { EdgarStatProcJobStep } from "../../src/ApplicationImplementation/Edgar/Jobs/EdgarStatisticsProcessing/Steps/StatisticsProcessing/EdgarStatProcJobStep.js";
import { IRCalculationResult } from "../../src/ApplicationImplementation/Edgar/Statistics/IRCalculationResult.js";
import { DatabaseConnection } from "../../src/ApplicationModel/Database/DatabaseConnection.js";
import { FrameworkConfigurationProvider } from "../../src/ApplicationModel/FrameworkConfiguration/FrameworkConfigurationProvider.js";
import { IJobConfiguration, JobWorkerConfig } from "../../src/ApplicationModel/Jobs/IJobConfiguration.js";
import { StepResult, IJobStep, getStepResultDBEnumValue } from "../../src/ApplicationModel/Jobs/IJobStep.js";
import { AbstractJobWorker } from "../../src/ApplicationModel/Jobs/Workers/AbstractJobWorker.js";
import { FrameworkLogger } from "../../src/Logger/FrameworkLogger.js";
import { GenericFactory } from "../../src/PluginSupport/GenericFactory.js";
...
const impl: IRegistryPlugin = {
    ...
    registry: "JobWorker",
    creationFunction(config: JobWorkerConfig, ...ctorArgs: any[]): object {
        const dbConn: DatabaseConnection | null = DatabaseConnectionRegistry.instance.getItem(
            config.databaseConnection
        );
        if (dbConn === null) {
